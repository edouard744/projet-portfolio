...
<header class="header">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="960" height="960" viewBox="0 0 960 960"><defs><linearGradient id="a" x1="0.888" y1="0.148" x2="0.21" y2="0.898" gradientUnits="objectBoundingBox"><stop offset="0" stop-color="#809d3f"/><stop offset="1" stop-color="#404f20"/></linearGradient></defs><circle cx="480" cy="480" r="480" fill="url(#a)"/></svg>
